			...
			public void onClick(View v) {
				try {
					...
					if(ET_doctorNo.getText().toString().equals("")) {
						Toast.makeText(DoctorAddActivity.this, "医生工号输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_cardNo.getText().toString().equals("")) {
						Toast.makeText(DoctorAddActivity.this, "身份证号输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_school.getText().toString().equals("")) {
						Toast.makeText(DoctorAddActivity.this, "毕业学校输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_workYears.getText().toString().equals("")) {
						Toast.makeText(DoctorAddActivity.this, "工作经验输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_memo.getText().toString().equals("")) {
						Toast.makeText(DoctorAddActivity.this, "备注输入不能为空!", Toast.LENGTH_LONG).show();
