...
public class DepartmentAddActivity extends Activity {
	...
	// 声明科室编号输入框
	private EditText ET_departmentNo;
	// 声明科室名称输入框
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ET_departmentNo = (EditText) findViewById(R.id.ET_departmentNo);
		...
		btnAdd.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					/*验证获取科室编号*/
					if(ET_departmentNo.getText().toString().equals("")) {
						Toast.makeText(DepartmentAddActivity.this, "科室编号输入不能为空!", Toast.LENGTH_LONG).show();
						ET_departmentNo.setFocusable(true);
						ET_departmentNo.requestFocus();
						return;
					}
					department.setDepartmentNo(ET_departmentNo.getText().toString());
					/*验证获取科室名称*/ 
					...
					if(ET_chargeMan.getText().toString().equals("")) {
						Toast.makeText(DepartmentAddActivity.this, "负责人输入不能为空!", Toast.LENGTH_LONG).show();
