			...
			public void onClick(View v) {
				try {
					...
					if(ET_drugName.getText().toString().equals("")) {
						Toast.makeText(DrugAddActivity.this, "药品名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_unit.getText().toString().equals("")) {
						Toast.makeText(DrugAddActivity.this, "药品单位输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_price.getText().toString().equals("")) {
						Toast.makeText(DrugAddActivity.this, "药品单价输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传药品信息*/
					DrugAddActivity.this.setTitle("正在上传药品信息，稍等...");
					String result = drugService.AddDrug(drug);
