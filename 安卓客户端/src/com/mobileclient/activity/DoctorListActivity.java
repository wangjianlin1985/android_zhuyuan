				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new DoctorSimpleAdapter(DoctorListActivity.this, list,
	        					...
	        					new String[] { "doctorNo","departmentObj","name","sex","cardNo","doctorPhoto","birthday","telephone" },
	        					new int[] { R.id.tv_doctorNo,R.id.tv_departmentObj,R.id.tv_name,R.id.tv_sex,R.id.tv_cardNo,R.id.iv_doctorPhoto,R.id.tv_birthday,R.id.tv_telephone,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < doctorList.size(); i++) {
				...
				map.put("cardNo", doctorList.get(i).getCardNo());
				...
				map.put("birthday", doctorList.get(i).getBirthday());
				map.put("telephone", doctorList.get(i).getTelephone());
				list.add(map);
			}
		} catch (Exception e) { 
