...
public class DepartmentService {
	...
	public String AddDepartment(Department department) {
		...
		params.put("departmentNo", department.getDepartmentNo());
		params.put("departmentName", department.getDepartmentName());
		params.put("bornDate", department.getBornDate().toString());
		params.put("chargeMan", department.getChargeMan());
	...
	public List<Department> QueryDepartment(Department queryConditionDepartment) throws Exception {
		...
		if(queryConditionDepartment != null) {
			if(queryConditionDepartment.getBornDate() != null) {
				urlString += "&bornDate=" + URLEncoder.encode(queryConditionDepartment.getBornDate().toString(), "UTF-8");
			}
		}
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				department.setDepartmentNo(object.getString("departmentNo"));
				department.setDepartmentName(object.getString("departmentName"));
				department.setBornDate(Timestamp.valueOf(object.getString("bornDate")));
				department.setChargeMan(object.getString("chargeMan"));
