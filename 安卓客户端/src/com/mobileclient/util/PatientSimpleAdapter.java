...
public class PatientSimpleAdapter extends SimpleAdapter { 
	/*需要绑定的控件资源id*/
    private int[] mTo;
    /*map集合关键字数组*/
...
/*需要绑定的数据*/
    ...
    public PatientSimpleAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to,ListView listView) { 
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  if (convertView == null) convertView = mInflater.inflate(R.layout.patient_list_item, null);
	  ...
	  holder.tv_originPlace = (TextView)convertView.findViewById(R.id.tv_originPlace);
	  ...
	  holder.tv_originPlace.setText("籍贯：" + mData.get(position).get("originPlace").toString());
