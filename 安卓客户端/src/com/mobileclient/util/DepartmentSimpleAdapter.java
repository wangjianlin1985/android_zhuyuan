...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  /*绑定该view各个控件*/
	  holder.tv_departmentNo = (TextView)convertView.findViewById(R.id.tv_departmentNo);
	  ...
	  /*设置各个控件的展示内容*/
	  holder.tv_departmentNo.setText("科室编号：" + mData.get(position).get("departmentNo").toString());
	  ...
	  holder.tv_chargeMan.setText("负责人：" + mData.get(position).get("chargeMan").toString());
	  /*返回修改好的view*/
	  return convertView; 
    } 

    static class ViewHolder{ 
    	TextView tv_departmentNo;
