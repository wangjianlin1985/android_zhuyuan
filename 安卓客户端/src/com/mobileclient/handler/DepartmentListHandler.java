...
public class DepartmentListHandler extends DefaultHandler {
	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if (department != null) { 
            ...
            if ("departmentNo".equals(tempString)) 
            	department.setDepartmentNo(valueString); 
            else if ("departmentName".equals(tempString)) 
            	department.setDepartmentName(valueString); 
            else if ("bornDate".equals(tempString)) 
            	department.setBornDate(Timestamp.valueOf(valueString));
            else if ("chargeMan".equals(tempString)) 
            	department.setChargeMan(valueString); 
        } 
	}
