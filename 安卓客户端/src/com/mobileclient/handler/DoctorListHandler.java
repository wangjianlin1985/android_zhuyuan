	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if (doctor != null) { 
            ...
            if ("doctorNo".equals(tempString)) 
            	...
            	doctor.setDepartmentObj(valueString); 
